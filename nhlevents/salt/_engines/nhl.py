...
def start(game_id, interval=3, replay=False, tag='salt/engines/nhl'):
    '''
    ...
    while True:
        ...
        # if we're not in replay mode, and engine just started, pick up at current play
        if (not replay) and (counter == 0):
